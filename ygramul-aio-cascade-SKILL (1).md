...
Full methodology: 7 sequenced levers + Karpathy auto-research loop as differentiator.

---

## Author

Built by **Ivan Nonveiller** — enterprise technical SEO and GEO strategist. 10+ years optimizing search visibility for brands including Walmart, AutoTRADER, Ferrari, Maserati, Ritz-Carlton, and BetterSleep. M.Sc. Intelligent Systems. Based in Montréal.

- LinkedIn: https://www.linkedin.com/in/ivannonveiller
- Methodology site: https://rushmedia.agency
- Contact: connect on LinkedIn and DM "AI Overview"

This skill is the open-source version of Ygramul's Lever 4 content judge system. The enterprise version includes cross-client calibration data, custom judge weighting per vertical, and the full Ygramul Codex (132-source intelligence library). Reach out if you're running enterprise SEO/GEO and want the deeper version.

## License

MIT. Use it, modify it, ship it in your own tools. Attribution appreciated but not required.
